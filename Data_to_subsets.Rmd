...
Run this line of code for all subsequent scripts in order to access the functions used. 
...
# Increase allowed size for variables (scRNAseq datasets are very large). 
options(future.globals.maxSize = 16 *  1024^3)
```
---  
# Data to Subsets.
## 1. Create a Seurat object.
The count matrix represents the number of molecules detected for each **feature** _(e.g. gene, represented by rows)_ across individual cells, identified by a **Unique Molecular Identifier** _(UMI, represented by columns)_. I convert the count matrix to a **Seurat object**, which serves as a container for both data _(e.g. count matrix)_ and analyses _(e.g. PCA, UMAP)_.
